...
export function CurtainPanel({
  ...
  const sweepClip = isLeft
    ? 'polygon(0% 0%, 68% 0%, 58% 14%, 46% 30%, 33% 48%, 20% 66%, 8% 84%, 0% 94%, 0% 100%)'
    : 'polygon(32% 0%, 100% 0%, 100% 100%, 100% 94%, 92% 84%, 80% 66%, 67% 48%, 54% 30%, 42% 14%)';
  const vanishClip = isLeft
    ? 'polygon(0% 0%, 24% 0%, 19% 14%, 14% 30%, 9% 48%, 5% 66%, 2% 84%, 0% 94%, 0% 100%)'
    : 'polygon(76% 0%, 100% 0%, 100% 100%, 100% 94%, 98% 84%, 95% 66%, 91% 48%, 86% 30%, 81% 14%)';
